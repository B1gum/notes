\lecture{8}{September 17, 2025}{Bernoulli Equation Continued}

\subsection{The Bernoulli Equation as an Energy Equation}
The Bernoulli equation, \Cref{eq:berneq}, has been derived by integration of Euler's equation along a streamline for a steady, incompressible, frictionless flow -- I.e. it was derived from the momentum equation for a fluid particle. 

Another equation, that looks almost identical to \Cref{eq:berneq}, although requiring very different restrictions can be obtained from the first law of thermodynamics. 

We consider steady flow in the absence of shear forces. We choose a control volume bounded by streamlines as shown on \Cref{fig:f6_5}, which is often called a \textit{stream tube}.

\begin{figure} [ht]
  \centering
  \includegraphics[width=0.6\linewidth]{./figures/f6_5.png}
...
.\]
We can see that this reduces to the Bernoulli Equation, \Cref{eq:berneq} if the term in parentheses were zero. Therefore if we impose the further restriction,
\[ 
...
For a steady, incompressible, frictionless flow we may use the Bernoulli equation, \Cref{eq:berneq}:
\[ 
...
,\]
i.e. the difference between the EGL and HGL is the dynamic pressure term. The function of this is shown graphically on \Cref{fig:f6_6}. Here it is worth noting that for incompressible, inviscid flow without work devices the EGL is constant. Furthermore, the HGL will always be lower than the EGL by distance $\frac{V^2}{2g}$. 

\begin{figure} [ht]
  \centering
  \includegraphics[width=0.7\linewidth]{./figures/f6_6.png}
