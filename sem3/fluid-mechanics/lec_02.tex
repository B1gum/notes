\lecture{2}{August 27, 2025}{Basic Equations of Fluid Statics and Buoyancy, Surface Tension}

\section{Fluid Statics} \label{sec:flusta}

\subsection{The Basic Equations of Fluid Statics}
Consider a differential fluid element of mass $\mathrm{d}m = \rho \, \mathrm{d}V$ with sides $\mathrm{d}x $, $\mathrm{d}y$, and $\mathrm{d}z$ as shown on \Cref{fig:f3_1}. The fluid element is stationary relative to the coordinate system shown.
...
.\]
We can now recognize the term in the parentheses as the gradient of the pressure which may be written as either $\grad p$ or $\nabla p$. This is:
\[ 
...
\[ 
\mathrm{d}\textbf{F}_S = - \grad p(\mathrm{d}x \, \mathrm{d}y \, \mathrm{d}z) = - \nabla p \, \mathrm{d}x \, \mathrm{d}y \, \mathrm{d}z
.\]
...
\subsection{Buoyancy}
Any object submerged in a liquid will experience a vertical force acting on it due to liquid pressure -- this is termed \textit{buoyancy}. Consider the object on \Cref{fig:f3_9} which is split into cylindrical volume elements.

\begin{figure} [ht]
  \centering
  \includegraphics[width=0.7\linewidth]{./figures/f3_9.png}
