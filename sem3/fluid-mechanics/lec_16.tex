...
As the boundary layer is defined as the area where viscous forces are present, as opposed to the free stream, where viscous forces are negligible, it is not unambigous exactly where the border between the two regions is drawn.
...
\begin{figure} [ht]
  \centering
  \includegraphics[width=0.8\linewidth]{./figures/f9_3.png}
