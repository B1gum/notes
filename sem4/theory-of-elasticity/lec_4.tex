...
\begin{equation} \label{eq:linmomprin}
  \int_V \Vec{f} \, \mathrm{d}V + \int_A \Vec{T} \, \mathrm{d}A = \int_V \rho \ddot{\Vec{u}} \, \mathrm{d}V
\end{equation}
...
\begin{equation} \label{eq:angmomprin}
  \int_V \left( \Vec{r} \times \Vec{f} \right) \, \mathrm{d}V + \int_A \left( \Vec{r} \times \Vec{T} \right) \, \mathrm{d}A = \int_V \left( \Vec{r} \times \rho \ddot{\Vec{u}} \right) \, \mathrm{d}V
\end{equation}
...
\begin{figure} [ht]
  ...
  \begin{subfigure}{0.38\linewidth}
    ...
    \label{fig:f2_6b}
  \end{subfigure}
  \caption{Normal section and principal plane}
\end{figure}
...
Furthermore, $\frac{\mathrm{d}\Vec{n}}{\mathrm{d}n} $ is normal to $\Vec{n}$, so $\Vec{T}_n$ must be parallel to $\Vec{n}$.
